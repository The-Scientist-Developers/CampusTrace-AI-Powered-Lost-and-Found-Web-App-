...
const LoginScreen = ({ navigation }) => {
  ...
  // Gradient colors for Instagram-inspired backgrounds
  const gradientColors = isDark
    ? {
        // Dark mode: Instagram dark blue-gray
        start: "#1C2A33",
        middle: "#1C2A33",
        end: "#1C2A33",
      }
  ...
  const styles = {
    ...
    button: {
      backgroundColor: isDark ? "#0095F6" : "#E1306C",
      borderRadius: 12,
      height: 48,
      justifyContent: "center",
      alignItems: "center",
    ...
    footerButton: {
      borderWidth: 1,
      borderColor: isDark ? "#0095F6" : "#0095F6",
      backgroundColor: "transparent",
      borderRadius: 12,
      height: 48,
      justifyContent: "center",
    ...
    toggleContainer: {
      ...
      marginBottom: 20,
      borderWidth: 1,
      borderColor: isDark ? "#2F3336" : "#DBDBDB",
    },
    toggleButton: {
      flex: 1,
      paddingVertical: 10,
  ...
  return (
    ...
    >
      ...
      >
        <Defs>
          <LinearGradient
            id={isDark ? "authGradientDark" : "authGradientLight"}
            x1="0%"
            y1="0%"
            x2="100%"
            y2="100%"
        ...
        <Rect
          width="100%"
          height="100%"
          fill={`url(#${isDark ? "authGradientDark" : "authGradientLight"})`}
        />
      </Svg>
