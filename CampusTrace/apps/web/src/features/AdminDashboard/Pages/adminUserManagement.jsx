  ...
  <div className="bg-white dark:bg-[#2a2a2a] border border-neutral-200 dark:border-[#3a3a3a] rounded-xl shadow-sm p-4 space-y-4">
    ...
    <div className="flex gap-2">
      <select
        value={user.role || "member"}
        onChange={(e) => changeRole(user.id, e.target.value)}
        className="form-select flex-1 bg-white dark:bg-[#1a1a1a] border border-neutral-300 dark:border-neutral-600 text-neutral-900 dark:text-neutral-100"
      >
        <option value="member">Member</option>
        <option value="moderator">Moderator</option>
        <option value="admin">Admin</option>
  ...
  <div className="bg-white dark:bg-[#2a2a2a] border border-neutral-200 dark:border-[#3a3a3a] rounded-xl shadow-sm p-4 space-y-4">
    ...
    <div className="grid grid-cols-2 gap-4 text-sm border-y border-neutral-200 dark:border-[#3a3a3a] py-3">
      ...
      <div>
        ...
        <Skeleton height={22} width={50} className="mt-1" borderRadius={999} />
      </div>
    </div>
    <div className="flex gap-2">
      <Skeleton height={42} className="flex-1" borderRadius={8} />
...
const UserTableRowSkeleton = () => (
  <tr>
    <td className="p-4 align-top">
      ...
      <Skeleton height={16} width="90%" className="mt-1" />
    </td>
    <td className="p-4 align-top">
...
const UserManagementSkeleton = () => (
  <div className="space-y-6">
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
      ...
      <Skeleton height={42} width={256} borderRadius={8} />
    </div>
...
export default function UserManagement({ user: sessionUser }) {
  ...
  }, [debouncedSearchTerm, sessionUser?.id, currentPage, rowsPerPage]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="hidden md:block bg-white dark:bg-[#2a2a2a] rounded-lg border border-neutral-200 dark:border-zinc-800 overflow-hidden">
        ...
        {/* Pagination Controls */}
        {users.length > 0 && (
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-4 py-3 border-t border-neutral-200 dark:border-zinc-800">
      ...
      <div className="block md:hidden space-y-4">
        {users.length === 0 ? (
          ...
          <>
            ...
            {/* Mobile Pagination */}
            <div className="bg-white dark:bg-[#2a2a2a] border border-neutral-200 dark:border-[#3a3a3a] rounded-xl p-4 space-y-3">
              ...
              <div className="flex items-center justify-center gap-2">
                <button
                  onClick={() => handlePageChange(currentPage - 1)}
                  disabled={currentPage === 1}
                  className="p-2 rounded-md border border-neutral-300 dark:border-neutral-600 disabled:opacity-50"
                >
                  <ChevronLeft className="w-5 h-5" />
                </button>
