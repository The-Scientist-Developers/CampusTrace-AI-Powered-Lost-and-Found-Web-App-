...
import { supabase } from "../../api/apiClient.js"; // Adjust path if needed
import { Clock, LogOut } from "lucide-react"; // Import relevant icons

function PendingApprovalPage() {
  const navigate = useNavigate();

  // Removed the polling useEffect as the primary redirect logic is in App.jsx.
  // This page is now mainly informational. You could add a manual refresh button if desired.
