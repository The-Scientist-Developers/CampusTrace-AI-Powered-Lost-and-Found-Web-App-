...
export default function LandingPage() {
  ...
  return (
    <div className="bg-white dark:bg-[#1a1a1a] text-neutral-800 dark:text-gray-100 min-h-screen flex flex-col">
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-[#1a1a1a]/80 backdrop-blur-md shadow-sm">
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-6">
              <Link
                ...
                className="text-base font-medium text-neutral-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-white transition-colors duration-200"
              >
                For Universities
              </Link>
              <Link
                to="/about"
                className="text-base font-medium text-neutral-600 dark:text-gray-400 hover:text-neutral-900 dark:hover:text-white transition-colors duration-200"
              >
                About Us
              </Link>
              <Link
      ...
      <main className="flex-grow pt-20">
        ...
        <section className="relative min-h-[calc(100vh-80px)] flex items-center justify-center text-center overflow-hidden">
          <div className="absolute inset-0 z-0 opacity-50">
            <div className="absolute inset-0 bg-gradient-to-br from-white to-neutral-100 dark:from-[#1a1a1a] dark:to-[#0a0a0a]"></div>
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <p className="mt-6 md:mt-8 max-w-2xl mx-auto text-lg sm:text-xl text-neutral-600 dark:text-gray-400 animate-fade-in-up animation-delay-200">
        ...
        <section className="py-20 bg-neutral-50 dark:bg-[#2a2a2a]">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-neutral-900 dark:text-white mb-4">
                A Simpler Way to Find & Report
              </h2>
              <p className="mt-4 text-xl text-neutral-600 dark:text-gray-400 max-w-3xl mx-auto">
        ...
        <section className="py-20 bg-white dark:bg-[#1a1a1a]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-8 bg-neutral-50 dark:bg-[#2a2a2a] rounded-xl border border-neutral-200 dark:border-[#3a3a3a]">
                ...
                <p className="mt-3 text-lg text-neutral-600 dark:text-gray-400 leading-relaxed">
        ...
        <section className="py-20 bg-gradient-to-br from-white to-neutral-100 dark:from-[#1a1a1a] dark:to-zinc-900 text-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-bold text-neutral-900 dark:text-white mb-6">
              Ready to Reconnect Your Campus?
            </h2>
            <p className="text-xl text-neutral-600 dark:text-gray-400 mb-10">
      ...
      <footer className="bg-neutral-100 dark:bg-[#1a1a1a] py-12">
