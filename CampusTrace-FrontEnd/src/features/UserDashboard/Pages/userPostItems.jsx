...
export default function PostNewItem() {
  ...
  return (
    <div className="text-neutral-900 dark:text-white">
      ...
      <form
        onSubmit={handleSubmit}
        className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl shadow-xl"
      >
        <div className="p-6 sm:p-8 space-y-6">
          <div>
            <label
            ...
            <input
              ...
              onChange={(e) => setTitle(e.target.value)}
              required
              className="w-full bg-neutral-100 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded-lg p-3 text-neutral-900 dark:text-white"
              placeholder="e.g., Black Backpack, iPhone 13"
            />
          </div>
          ...
          <div>
            ...
            <div className="mt-2 p-6 border-2 border-dashed border-neutral-300 dark:border-neutral-700 rounded-lg text-center">
              {imagePreview ? (
                <div className="relative inline-block">
                  <img
                    src={imagePreview}
                  ...
                  <button
                    type="button"
                    onClick={removeImage}
                    className="absolute -top-2 -right-2 p-1 bg-neutral-200 dark:bg-neutral-700 rounded-full text-neutral-900 dark:text-white hover:bg-neutral-300 dark:hover:bg-neutral-600"
                  >
                    <X className="w-4 h-4" />
                  </button>
                </div>
                ...
                <div className="flex flex-col items-center">
                  <ImageIcon className="w-12 h-12 text-neutral-600 dark:text-neutral-500 mb-4" />
                  <label
                    htmlFor="image-upload"
                    className="px-4 py-2 bg-neutral-200 dark:bg-neutral-700 text-neutral-900 dark:text-white text-sm font-semibold rounded-md hover:bg-neutral-300 dark:hover:bg-neutral-600 cursor-pointer"
                  >
                    Browse
                  </label>
                  <input
        ...
        <div className="p-6 sm:p-8 bg-neutral-100 dark:bg-neutral-900/50 border-t border-neutral-200 dark:border-neutral-800 rounded-b-xl flex justify-end">
          <button
            type="submit"
            disabled={isSubmitting}
            className="flex items-center gap-2 px-6 py-3 bg-red text-white font-semibold text-sm rounded-md hover:bg-red/80 disabled:opacity-50"
