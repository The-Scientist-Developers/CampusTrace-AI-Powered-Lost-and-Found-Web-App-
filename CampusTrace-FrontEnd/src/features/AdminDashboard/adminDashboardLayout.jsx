      ...
      <main className="flex-1 overflow-y-auto bg-slate-50 dark:bg-black">
        <div className="p-4 sm:p-6 lg:p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 bg-white dark:bg-neutral-900 p-6 rounded-lg border border-neutral-200 dark:border-neutral-800">
...
export default function AdminDashboardLayout({ children, user, isLoading = false }) {
  const navigate = useNavigate();
  const location = useLocation();
  const { theme, toggleTheme } = useTheme();

  // DEBUG LOGS
  console.log("=== AdminDashboardLayout Render ===");
  ...
  if (isLoading) {
    ...
    return <AdminDashboardSkeleton isSidebarOpen={isSidebarOpen} mobileMenu={mobileMenu} />;
  }

  console.log("🟢 SHOWING ACTUAL CONTENT - isLoading is FALSE");
