        ...
        <div className="bg-slate-900 text-slate-300">
                ...
                <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-20">
                        <div className="flex items-center">
                            <span className="text-2xl font-bold text-white">Campus Trace</span>
                        </div>
                        <div className="flex items-center">
                            <button 
                                onClick={onNavigateToLogin} 
                                className="px-5 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-lg shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-slate-900">
                                Log In
                            </button>
                        </div>
                    </div>
                ...
                <section className="min-h-screen flex items-center pt-20">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <div className="mt-8">
                            ...
                            <button 
                                onClick={onNavigateToLogin}
                                className="px-8 py-3 bg-indigo-600 text-white text-base font-semibold rounded-lg shadow-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-slate-900">
                                Get Started
                            </button>
                        </div>
                    </div>
                ...
                <section className="py-20 bg-slate-950">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center">
                            ...
                            <p className="mt-4 text-lg text-slate-400">A modern solution to an old problem.</p>
                        </div>
                        <div className="mt-16 grid md:grid-cols-3 gap-12">
                            {}
                            <div className="text-center">
                                <div className="flex items-center justify-center h-16 w-16 mx-auto bg-slate-800 rounded-full">
                                    <SecureIcon />
                                </div>
                                <h3 className="mt-6 text-xl font-semibold text-white">Secure & Verified</h3>
                                <p className="mt-2 text-slate-400">
                                    Using a Magic-Link sent to your official university email, we ensure every user is a verified member of our campus community.
                                </p>
                            </div>
                            {}
                            <div className="text-center">
                                ...
                                <h3 className="mt-6 text-xl font-semibold text-white">AI-Powered Search</h3>
                                <p className="mt-2 text-slate-400">
                                    Our system leverages Gemini AI to analyze descriptions and extract relevant tags, making your search results faster and more accurate.
                                </p>
                            </div>
                            {}
                            <div className="text-center">
                                ...
                                <h3 className="mt-6 text-xl font-semibold text-white">Smart Matching</h3>
                                <p className="mt-2 text-slate-400">
                                    Our custom-built algorithm proactively finds high-probability matches and notifies you, so you can stop searching and start recovering.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <footer className="bg-slate-900">
                <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-center">
                    <p className="text-slate-400">&copy; 2025 Campus Trace. A project by Bugauisan, Respicio, & Cacho.</p>
                </div>
            </footer>
        </div>
    );
